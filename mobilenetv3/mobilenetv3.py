...
from ._utils import _make_divisible, _log_api_usage_once
...
if __name__ == '__main__':
    model_path = '/da2/wangjiahua/TianSuan/OCR_TianSuan/DBNetPyTorch-main/pretrain_models/mobilenet_v3_large-8738ca79.pth'
